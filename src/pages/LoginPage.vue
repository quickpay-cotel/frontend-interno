  ...
  <v-container fill-height class="d-flex align-center justify-center" style="min-height: 100vh;">
    <v-card class="pa-5" elevation="10" width="800" style="background-color: #ffffff; border-radius: 12px;">
      <v-row no-gutters>
        <v-col cols="6" class="pa-5 d-flex flex-column justify-center">
          ...
          <v-card-text>
            <v-form ref="loginForm" @submit.prevent="login">
              <v-text-field v-model="username" label="Usuario"  variant="outlined" :rules="[rules.required]"></v-text-field>
        ...
        <v-col cols="6" class="pa-5 d-flex flex-column justify-center align-center" style="background-color: #E3F2FD; border-radius: 0 12px 12px 0;">
